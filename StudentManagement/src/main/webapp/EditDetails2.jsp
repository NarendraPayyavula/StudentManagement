...
<div class="container mt-5">
    ...
    <form class="form-inline mb-4" action="EditDetails2.jsp" method="get">
    ...
    <form action="EditDetails2.jsp" method="post">
        ...
        try {
            ...
            if (idNo != null && !idNo.isEmpty()) {
                ...
                PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM second WHERE IdNo = ?");
...
try {
    if (request.getMethod().equals("POST")) {
        ...
        PreparedStatement pstmt = conn.prepareStatement("UPDATE second SET FirstName=?, LastName=?, Gender=?, City=?, State=?, PhoneNumber=?, Email=? WHERE IdNo=?");
