...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <form action="AddStudent5.jsp" method="post" class="nav-link">
                    <button class="btn btn-link" type="submit">Add Student</button>
                </form>
            </li>
            <li class="nav-item">
                <form action="DeleteStudent5.jsp" method="post" class="nav-link">
                    <button class="btn btn-link" type="submit">Remove Student</button>
                </form>
            </li>
            <li class="nav-item">
                <form action="EditDetails5.jsp" method="post" class="nav-link">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <% 
                    try {
                        ...
                        if (idNo != null && !idNo.isEmpty()) {
                            ...
                            ResultSet rs = stmt.executeQuery("SELECT * FROM Fifth WHERE IdNo = '" + idNo + "'");
                ...
                <% }
                            ...
                            ResultSet rs = stmt.executeQuery("SELECT * FROM Fifth");
                            // Iterate over the result set and display data
                            while (rs.next()) {
                %>
                                <tr>
