...
<div class="container mt-5">
    ...
    <form class="form-inline mb-4" action="EditDetails1.jsp" method="get">
    ...
    <form action="EditDetails1.jsp" method="post">
        <%
        try {
            ...
            if (idNo != null && !idNo.isEmpty()) {
                ...
                PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM First WHERE IdNo = ?");
...
try {
    if (request.getMethod().equals("POST")) {
        ...
        PreparedStatement pstmt = conn.prepareStatement("UPDATE First SET FirstName=?, LastName=?, Gender=?, City=?, State=?, PhoneNumber=?, Email=? WHERE IdNo=?");
