...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <form action="AddStudent1.jsp" method="post" class="nav-link">
                    <button class="btn btn-link" type="submit">Add Student</button>
                </form>
            </li>
            <li class="nav-item">
                <form action="DeleteStudent1.jsp" method="post" class="nav-link">
                    <button class="btn btn-link" type="submit">Remove Student</button>
                </form>
            </li>
            <li class="nav-item">
                <form action="EditDetails1.jsp" method="post" class="nav-link">
                ...
                <% 
                    try {
                        ...
                        if (idNo != null && !idNo.isEmpty()) {
                            ...
                            ResultSet rs = stmt.executeQuery("SELECT * FROM First WHERE IdNo = '" + idNo + "'");
