...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <form action="AddStudent4.jsp" method="post" class="nav-link">
                    <button class="btn btn-link" type="submit">Add Student</button>
                </form>
            </li>
            <li class="nav-item">
                <form action="DeleteStudent4.jsp" method="post" class="nav-link">
                    <button class="btn btn-link" type="submit">Remove Student</button>
                </form>
            </li>
            <li class="nav-item">
                <form action="EditDetails4.jsp" method="post" class="nav-link">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <% 
                    try {
                        ...
                        if (idNo != null && !idNo.isEmpty()) {
                            ...
                            ResultSet rs = stmt.executeQuery("SELECT * FROM Fourth WHERE IdNo = '" + idNo + "'");
                ...
                <% }
                            ...
                            ResultSet rs = stmt.executeQuery("SELECT * FROM Fourth");
                            // Iterate over the result set and display data
                            while (rs.next()) {
                %>
                                <tr>
