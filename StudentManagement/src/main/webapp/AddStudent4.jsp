    ...
    <div class="container">
        ...
        <% if ("POST".equalsIgnoreCase(request.getMethod())) {
            try {
                ...
                String sql = "INSERT INTO Fourth(IdNo, FirstName, LastName, Gender, City, State, PhoneNumber, Email) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                response.sendRedirect("AddStudent4.jsp?status=success");
                
            } catch (ClassNotFoundException | SQLException e) {
                e.printStackTrace();
                // Redirect to the add student form with error message
                response.sendRedirect("AddStudent4.jsp?status=error&message=" + e.getMessage());
            }
        } %>
        <form method="post" action="AddStudent4.jsp">
